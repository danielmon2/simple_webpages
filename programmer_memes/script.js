...
function makeParagraphElement(parentDiv, content, color) {
...
function showJoke() {
    ...
    makeParagraphElement(jokeDiv, randomJokeText, '#828A9B');
}
...
function showQuote() {
    ...
    makeParagraphElement(quoteDiv, randomQuote.quote, '#828A9B');
    makeParagraphElement(quoteDiv, ' - ' + randomQuote.author, '#828A9B');
}
...
function showRiddle() {
    ...
    makeParagraphElement(riddleDiv, randomRiddle.question, '#828A9B');
    const answerElem = document.createElement('p');
    answerElem.textContent = randomRiddle.answer;
    answerElem.style.color = '#828A9B';
    answerElem.hidden = true;
    riddleDiv.appendChild(answerElem);
}
...
function revealAnswers() {
    const answerElem = riddleDiv.lastChild;
    if (riddleDiv.children.length === 0) {
        console.log('No riddle shown');
    }
    else if (answerElem.hidden === false) {
        console.log('Answer already shown');
    }
    else {
...
const riddles = [
  ...
  { question: 'What word in the English language does the following: the first two letters signify a male, the first three letters signify a female, the first four letters signify a great, while the entire word signifies a great woman. What is the word?', answer: 'Heroine' }
];
